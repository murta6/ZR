...
Drugo poglavlje završnog rada između ostaloga iznosi tezu o kvalitetnoj granulaciji znanja u sustavu za inteligentno učenje. Stoga je njoj bio posvećen velik dio planiranja implementacije sustava. 

TODO: PRIHATLJIVA RAZINA ZNANJA
...
\begin{itemize}
\item \textbf{Preduvjet} Ovaj odnos definira nemogućnost otvaranja sljedeće granulacije prije postizanja prihvatljive razine znanja u baznoj.
...
\subsubsection{Zapis u bazi podataka}
Svako pitanje u bazi predstavljeno je entitetom zadatak koji sadrži tekstualno pitanje, matematički izraz koji treba izračunati, eventualno sliku te parametre. Parametri trebaju biti tekstualnom obliku

\subsubsection{Izračun parametara}

\subsection{Mogućnosti administratora}
U sustavu postoje (zasad) predodređeni administratori pojedinih predmeta
samo na svojem predmetu
